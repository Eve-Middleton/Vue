...
<script>
	// 以下路径需根据项目实际情况填写
	// import { pathToBase64, base64ToPath } from '../../static/js/imgae-tools/index.js'
		...
		getImagTempUrl(context){
			...
			uni.downloadFile({
			  ...
			  success(res) {
				...
				//   .then(base64 => {
				//     context.drawImage(base64,0,0,500,280);
				//   })
				//   .catch(error => {
				//     console.error(error)
				//   })
